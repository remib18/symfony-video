 ...
 */
final class Version20231130171015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE home_pages (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, markdown LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE website_settings (id INT AUTO_INCREMENT NOT NULL, active_homepage_id INT DEFAULT NULL, singleton_guard INT NOT NULL, UNIQUE INDEX UNIQ_3452E948518E1891 (active_homepage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
